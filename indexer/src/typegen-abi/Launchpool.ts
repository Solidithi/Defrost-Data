...
export const functions = {
    ...
    claimProjectTokens: fun("0x7950ea7e", "claimProjectTokens()", {}, ),
...
export type ClaimProjectTokensParams = FunctionArguments<typeof functions.claimProjectTokens>
export type ClaimProjectTokensReturn = FunctionReturn<typeof functions.claimProjectTokens>
